#import "CordovaMusic.h"

@import NotificationCenter;
@import MediaPlayer;
@import StoreKit;

@implementation CordovaMusic
...
- (void)getAlbums:(CDVInvokedUrlCommand*)command {
  [self.commandDelegate runInBackground:^{
    ...
    NSArray *albums = [myAlbumsQuery collections];
    NSMutableArray* returnAlbums = [NSMutableArray arrayWithCapacity:1];
...
//      NSURL *imageURL = [image valueForKey:UIImagePickerControllerReferenceURL];
//      
//      NSLog(@"%@", imageURL);
      
      NSMutableDictionary* albumObj = [NSMutableDictionary dictionaryWithCapacity:1];
      [albumObj
        setObject: [NSString stringWithFormat:@"%@", [album valueForProperty: MPMediaItemPropertyPersistentID]]
        forKey:@"pid"
      ];
      [albumObj
       setObject: [NSString stringWithFormat:@"%@", [album valueForProperty: MPMediaItemPropertyArtist]]
       forKey:@"artist"
       ];
      [albumObj
       setObject: [NSString stringWithFormat:@"%@", [album valueForProperty: MPMediaItemPropertyAlbumTitle]]
       forKey:@"title"
       ];
      [albumObj
       setObject: [NSString stringWithFormat:@"%@", [album valueForProperty: MPMediaItemPropertyAlbumTrackCount]]
       forKey:@"trackCount"
       ];
      [albumObj
       setObject: [NSString stringWithFormat:@"%@", [album valueForProperty: MPMediaItemPropertyArtwork]]
       forKey:@"artwork"
       ];
      [returnAlbums addObject:albumObj];
    }
    
    
        
    CDVPluginResult* pluginResult = [CDVPluginResult resultWithStatus:CDVCommandStatus_OK messageAsArray:returnAlbums];
